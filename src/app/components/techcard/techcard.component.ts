...
export class TechcardComponent {
  items = [
    ...
    { img: 'assets/techs/typescript.svg', name: 'TypeScript', level: 4, category: 'Frontend' },
    ...
    { img: 'assets/techs/sass.svg', name: 'Sass', level: 5, category: 'Frontend' },
    { img: 'assets/techs/tailwindcss.svg', name: 'Tailwind', level: 4, category: 'Frontend' },
    ...
    { img: 'assets/techs/django.svg', name: 'Django', level: 4, category: 'Backend'},
    ...
    { img: 'assets/techs/kotlin.svg', name: 'Kotlin', level: 1, category: 'Mobile'},

    // Banco de dados
    { img: 'assets/techs/postgresql.svg', name: 'PostgreSQL', level: 5, category: 'Banco de dados'},
    ...
    // Infraestrutura
    { img: 'assets/techs/aws.svg', name: 'AWS', level: 2, category: 'Devops'},
    { img: 'assets/techs/google-cloud.svg', name: 'Google Cloud', level: 3, category: 'Devops'},
    { img: 'assets/techs/docker.svg', name: 'Docker', level: 3, category: 'Devops'},
    { img: 'assets/techs/terraform.svg', name: 'Terraform', level: 2, category: 'Devops'},
  ...
  filters = ['Todos', 'Frontend', 'Backend', 'Mobile', 'Banco de dados', 'Devops', 'Ferramentas'];
